...
<!-- datatables buttons-->
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title" data-i18n="maintenance">Maintenance</h3>
							...
							<div class="tab-content">
							  <div id="tab_form" class="tab-pane fade in active">
							    <form id="form_data" method="post" action="#" enctype="application/x-www-form-urlencoded"  role="form" >
                                        ...
                                        <!--<div class="form-group">
			                              <label style="font-weight:normal" data-i18n="title_event_type">Type</label>
			                             <select class="select-search" id="type" name="type" multiple="multiple">											                    											                    											                    
					                    <option value="" data-i18n="title_select2">Seleccione una opc&atilde;n...</option>
					                            <option value="distance" data-i18n="distance">Distance</option>											                    
					                           <option value="totalDistance" data-i18n="totaldistance">Total distance</option>
					                          <option value="odometer" data-i18n="odometer">Odometer</option>			                    
			                             </select>
		                              </div>-->
                                      ...
                                      <div class="form-group">
										    <label for="name" style="font-weight:normal" data-i18n="maintenance_start">Start</label>
											<input type="text" id="start" name="start" class="form-control" maxlength="80" placeholder="" />
									    </div>
                                        
                                        <div class="form-group">
										    <label for="name" style="font-weight:normal" data-i18n="maintenance_period">Period</label>
											<input type="text" id="period" name="period" class="form-control" maxlength="80" placeholder="" />
									    </div>
                                ...
                                <table class="table datatable-js" id="datatable">
		                            <thead>
			                            <tr>
                                            ...
                                            <th data-i18n="maintenance_type">Type</th>
                                            <th data-i18n="maintenance_start1">Start</th>
                                            <th data-i18n="maintenance_period1">Period</th>                                                                                                                                                                                            
                                            <th>&nbsp;</th>
                                        </tr>
		                            </thead>
	                            </table>
