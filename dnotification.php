...
?>
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title" data-i18n="title_notifications">Notification</h3>
							...
							<div class="tab-content">
							  <div id="tab_form" class="tab-pane fade in active">
							    <form id="form_data" method="post" action="#" enctype="application/x-www-form-urlencoded"  role="form" >
                					    ...
                					    <div class="form-group">
						                    <label style="font-weight:normal" data-i18n="title_notifications">Notification</label>
						                    <select class="select-search" id="notificationId" name="notificationId">											                    											                    											                    
								                    <option value="" data-i18n="title_select2">Selecione uma op&ccedil;&atilde;o...</option>											                    
						                    </select>
					                    </div>
                                ...
                                <table class="table datatable-js" id="datatable">
		                            <thead>
			                            <tr>
                                            ...
                                            <th data-i18n="title_channel">Channels</th>
                                            <th data-i18n="title_alarm">Alarms</th>
                                            <th>&nbsp;</th>
                                        </tr>
		                            </thead>
	                            </table>
	...
	<script src="assets/js/apps/commons/dnotification.js"></script>
