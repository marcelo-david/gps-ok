...
?>
    ...
    <div class="main-content">
        <div class="container-fluid">
            <h3 class="page-title">Emissão de boleto bancário PAGHIPER</h3>
                    ...
                    <div class="tab-content">
                        <div id="tab_form" class="tab-pane fade in active">
                             <div class="form-group">
                                    <label for="orderID" style="font-weight:normal">Order ID</label>
                                    <input type="text" id="orderID" name="orderID" class="form-control" maxlength="80" placeholder="" />
                                </div>

                                <div class="form-group">
                                    <label for="payerEmail" style="font-weight:normal">E-mail do pagador</label>
                                    <input type="text" id="payerEmail" name="payerEmail" class="form-control" maxlength="80" placeholder="" />
                                </div>

                                <div class="form-group">
                                    <label for="payerName" style="font-weight:normal">Nome do pagador</label>
                                    <input id="payerName" name="payerName" class="form-control" type="text" maxlength="80" />
                                </div>

                                <div class="form-group">
                                    <label for="cpfcnpj" style="font-weight:normal">CPF or CNPJ</label>
                                    <input id="cpfcnpj" name="cpfcnpj" class="form-control" type="text" maxlength="80" />
                                </div>

                                <div class="form-group">
                                    <label for="dueDate" style="font-weight:normal">Data de vencimento</label>
                                    <input id="dueDate" name="dueDate" class="form-control" type="number" maxlength="80" />
                                </div>

                                <div class="form-group">
                                    <label for="bankSlip" style="font-weight:normal">Boleto Bancário</label>
                                    <input id="bankSlip" name="bankSlip" class="form-control" type="text" maxlength="80" />
                                </div>

                                <br /><br />

                                <div>
                                    <button onclick="bankSlipIssaunce()" class="btn btn-primary" name="btnSave"><span>Submit</span> <i class="icon-arrow-right14 position-right"></i></button>
                                    &nbsp; &nbsp; &nbsp;
    ...
    <script src="assets/js/plugins/leaflet.pm.min.js"></script>
