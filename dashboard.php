...
?>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAchdvg28ywQFzEMHPerip8phY9WhBsMhs&v=3"></script>
    ...
    <body>
        <div id="loader_site">
            ...
            <div id="divElement" data-i18n="title_loading" style="margin-top: -30px">Aguarde o carregamento...
            </div>
        </div>
        <div id='cssmenu'>
            <ul >
