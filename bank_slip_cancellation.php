                    ...
                    <div class="tab-content">
                        <div id="tab_form" class="tab-pane fade in active">
                                ...
                                <div class="form-group">
                                    <label for="status" style="font-weight:normal">Status</label>
                                    <input type="text" id="status" name="status" class="form-control" maxlength="80" placeholder="" />
                                </div>
                                ...
                                <div>
                                    <button onclick="bankSlipCancellation()" class="btn btn-primary" name="btnSave"><span>Submit</span> <i class="icon-arrow-right14 position-right"></i></button>
                                    &nbsp; &nbsp; &nbsp;
