					...
					<div class="panel-body">			
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<img id="preview_logomark" src="assets/img/white-logo.png" style="cursor: pointer; width: 100%px; height:auto;" /><br />													
												</div>												
											</div>	
						...
						<h2>Mail server configuration</h2>
							...
							<form id="form_terms" method="post" action="#" enctype="application/x-www-form-urlencoded"  role="form" >
									...
									<div class="row">
										<div class="form-group">											
											<textarea id="term" name="term" class="form-control" rows="0" placeholder=""  disabled> </textarea>
										</div>
									</div>
