...
?>
    ...
    .footer {
     ...
     rgba(0, 0, 0, 0.1),
        ...
        <body class="login-container background-outh  pace-done" style="background-size: cover;"><div class="pace  pace-inactive"><div class="pace-progress" style="transform: translate3d(100%, 0px, 0px);" data-progress-text="100%" data-progress="99">
...
<!-- WhatsHelp.io widget --><script type="text/javascript">
    (function () {
        var options = {
            ...
            whatsapp: "+558196061782", // WhatsApp number
