...
<!-- datatables buttons-->
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title" data-i18n="title_asig_rfid">Drivers</h3>
							...
							<div class="tab-content">
							  <div id="tab_form" class="tab-pane fade in active">
							    <form id="form_data" method="post" action="#" enctype="application/x-www-form-urlencoded"  role="form" >
                					    ...
                					    <div class="form-group">
						                    <label style="font-weight:normal" data-i18n="title_asig_rfid">Drivers</label>
						                    <select class="select-search" id="driverId" name="driverId">											                    											                    											                    
								                    <option value="" data-i18n="title_select2">Selecione uma op&ccedil;&atilde;o...</option>											                    
						                    </select>
					                    </div>
                                ...
                                <table class="table datatable-js" id="datatable">
		                            <thead>
			                            <tr>
                                            ...
                                            <th data-i18n="title_number_rfid">No. RFID</th>
	...
	<script src="assets/js/apps/commons/ddrivers.js"></script>
	          <?php	
