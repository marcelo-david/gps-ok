...
<!-- datatables buttons-->
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title" data-i18n="title_asig_task">Asig task</h3>
							...
							<div class="tab-content">
							  <div id="tab_form" class="tab-pane fade in active">
							    <form id="form_data" method="post" action="#" enctype="application/x-www-form-urlencoded"  role="form" >
                					    ...
                					    <div class="form-group">
						                    <label style="font-weight:normal" data-i18n="title_asig_task">Asig task</label>
                                ...
                                <table class="table datatable-js" id="datatable">
		                            <thead>
			                            <tr>
                                            ...
                                            <th data-i18n="title_task_start">Start</th>
                                            <th data-i18n="title_task_end">End</th>
                                            <th data-i18n="title_type">type</th>
                                            <th data-i18n="title_task_priority">Priority</th>
                                            <th>&nbsp;</th>
                                        </tr>
		                            </thead>
	                            </table>
	...
	<script src="assets/js/apps/commons/dtask.js"></script>
