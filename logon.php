...
<!-- Bootstrap Material Datetime Picker Css -->
	...
	<div class="main-content">
		<div class="container-fluid">
			<h3 class="page-title" data-i18n="title_reports_access">Acesso ao Relatório</h3>
					...
					<div class="tab-content">							  
					    <form id="form_report" method="post" action="#" enctype="application/x-www-form-urlencoded"  role="form" >
                            ...
                            <div class="text-right">
                                <button type="submit" class="btn btn-primary" name="btnGenerate"><span data-i18n="button_generate">Gerar</span><i class="icon-arrow-right14 position-right"></i></button>
                                &nbsp; &nbsp; &nbsp;
				    ...
				    <table class="table datatable-js" id="datatable">
                        <thead>
                            <tr>                                                	            			        
								...
								<th data-i18n="title_disabled">Disabilitado</th>                                        
								<th data-i18n="title_count_access">Acesso a conta</th>
								<th data-i18n="title_last_login">Último login</th>	
                                <th data-i18n="title_create_device">Criar</th>							
                            </tr>
                        </thead>
                    </table>
