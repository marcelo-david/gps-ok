...
var token = "HLWDFEGNX2TTSMXVDMGXC8AU1A5U7MKP7G2NVJBSM4LE";
var apiKey = "apk_47210326-uDpoyohaZcftsOVhYqUQGhkfTFVOxyAr";
	...
	$.ajax({
        ...
        success: function (response) {
            ...
            $.each(response, function (key, value) {
                ...
                convertMeters(value.distance,
                sessionStorage.getItem('distanceUnit')),
                devicestempHoras,
            ...
            //                       {
            //                         alignment: 'left',
            //                         text: 'Reporte de recorridos resumidos ',
            //                         fontSize: 25
            //                       },
            //
            //                       {
...
function bankSlipCancellation(){
    var params = {
        "token":token,
        "apiKey":apiKey,
        "transaction_id": document.getElementById("transactionID").value,
        "status": document.getElementById("transactionID").value
    };
    $.ajax({
        type: "POST",
...
function bankSlipIssaunce(){
    var params = {
        ...
        "payer_cpf_cnpj": document.getElementById("cpfcnpj").value,
        "days_due_date ": document.getElementById("dueDate").value,
        "type_bank_slip ": document.getElementById("bankSlip").value,
    };
    $.ajax({
        type: "POST",
        url: "https://api.paghiper.com/transaction/cancel/",
