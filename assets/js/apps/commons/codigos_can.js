        ...
        success: function(response) {
            ...
            $.each(response, function(key, value) {
                ...
                if (obd == "OBD") {
                    ...
                    var code1 = ('code1' in value.attributes) ? value.attributes.code1 : "";
                    var code2 = ('code2' in value.attributes) ? value.attributes.code2 : "";
                    var code3 = ('code3' in value.attributes) ? value.attributes.code3 : "";
                    var code4 = ('code4' in value.attributes) ? value.attributes.code4 : "";
                    var code5 = ('code5' in value.attributes) ? value.attributes.code5 : "";
                    var code6 = ('code6' in value.attributes) ? value.attributes.code6 : "";
                    // dataSet.push([moment(value.serverTime).format('DD/MM/YYYY HH:mm:ss'), findDevice(value.deviceId).name, traduce(alarm), value.speed]);
                    dataSet.push([moment(value.serverTime).format('DD/MM/YYYY HH:mm:ss'), findDevice(value.deviceId).name, $.i18n("title_codes_"+code1),$.i18n("title_codes_"+code2), $.i18n("title_codes_"+code3), $.i18n("title_codes_"+code4), $.i18n("title_codes_"+code5), $.i18n("title_codes_"+code6)]);
                }
            });
            ...
            $('.datatable-js').dataTable({
                ...
                //{extend: 'excelHtml5',
			              ...
			              //}
                           ...
                           extend: 'pdfHtml5',
                            title: $.i18n("title_reports_codigos"),
                            className: 'expPDF',                    
                            ...
                            doc['header'] = (function (page, pages) {
                                ...
                                doc.content.splice(0, 0,                          
                                  {
                                    alignment: 'left',
                                    text: 'Reporte de codigos CanBUS',
                                    fontSize: 25
                                  },
                                  {
                                    alignment: 'left',
...
function traduce(alarma) {
    ...
    switch (alarma) {
        ...
        case 'mobileyeLr':
            ...
            // break;
        case 'mobileyePcw':
            final = 'Advertencia de Colisi&oacute;n a Peatones. PCW'
            break;
        case 'mobileyeUfcw':
            final = 'Advertencia Urbana de Colision Frontal por debajo de 30 km/h. UFCW'
            break;
        case 'mobileyeError':
        ...
        case 'mobileyeHmw':
            ...
            break;
        case 'mobileyeLl':
            final = 'Detector de lineas Viales Izquierda LD'
            break;
        case 'MobileyeFcw':
            final = 'Advertencia de Colision Frontal. FCW'
            break;
