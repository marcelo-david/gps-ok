...
$(document).ready(function() {
    ...
    $.extend($.fn.dataTable.defaults, {
        ...
        language: {
            ...
            "info": "Displays of _START_ of _END_ of _TOTAL_ records",
            "infoEmpty": "showing of 0 of 0 of 0 records",
            "infoFiltered": "(filtering _MAX_ records)",
            "infoPostFix": "",
            "thousands": ",",
            ...
            "aria": {
                ...
                "sortDescending": ": enable to sort the descending column"
            }
        },
    ...
    $('button[name="btnSave"]').click(function() {
        if ($('#form_alarm').valid()) { doSaveNotifications(); };
    });
    
    $('button[name="btnSave"]').click(function() {
        if ($('#form_mobileye').valid()) { doSaveNotifications(); };
    });
    
    
    
        $('#pane_form').on('click', function () {
        doListNotifications();
     ...
     $('#alarm').on('click', function () {
        ...
        console.log("Click on alarm")
		});
     
        $('#mobileye').on('click', function () {
        doListNotifications2();
        console.log("Click on mobileye")
		});
 ...
 if(sessionStorage.getItem('perfil') == "seg") {
        //seguridad  alarmas
        //Eventos
		$("#tab_form").show();
        $("#pane_form").show();
     ...
     if(sessionStorage.getItem('perfil') == "dia") {
        //diagnostico
        //Eventos
		$("#tab_form").show();
        $("#form_pane").show();
    ...
    if(sessionStorage.getItem('perfil') == "hab") {
        //habitos de manejo
        //Eventos
	    $("#tab_form").show();
        $("#pane_form").show();
    ...
    $.ajax({
        ...
        error: function(response) {
            switch (response.status) {
                case 400:
                    doOpenAlertError('User not allowed to perform this operation.');
                    break;
                case 401:
                    doOpenAlertError('Usuario no autorizado.');
                    break;
                default:
                    doOpenAlertError('Failed to perform the operation! Contact or technical support.\n Erro:' + response.statusText);
                    break;
            }
        },
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            for (i = 0; i < alarmas.length; i++) {
                ...
                dataSet.push([' ' + $.i18n("title_"+alarmas[i]), web, mail, sms, firebase, telegram]);
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            for (i = 0; i < mobileye.length; i++) {
                ...
                dataSet.push(['' + $.i18n("title_"+mobileye[i]), web, mail, sms, firebase, telegram]);
...
function doListUserNotify() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            doOpenAlertSucess('Exit!', 'Changes saveds', 500);
...
function doSaveNotifications(type) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            doOpenAlertSucess('Exit!', 'Changes saved', 1000);
