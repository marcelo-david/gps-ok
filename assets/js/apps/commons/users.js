...
$(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response != 0) {
                            ...
                            $("#preview_photo").prop("src", urlA = 'http://' + urlA + '/img/users/' + photo).css('height', '125px').css('width', '200px').css('float', 'left');
    ...
    $("#register").select2().on("change", function (e) {
        if (e.val == "false" || sessionStorage.getItem('administrator') == "true") {
            $('#adminField').show();
            $('#URLoginV').hide();
        } else {
            $('#adminField').hide();
            ...
            $.each(response, function (key, value) {
               ...
               ruta = "";
                if(photo == ""){
                    ...
                    ruta = "provider/" +value.id +"/"+ photo;
                }
                //FOTO por si se usa=('<img src="'+ruta+'"  width="50" height="50">')


                //dataSet.push([value.id, value.name, value.email, value.phone, state, (value.disabled?$.i18n("title_yes"):$.i18n("title_no")), (register=="yes"?$.i18n("title_yes"):$.i18n("title_no")), html]);
...
function doSaveUsers() {
    ...
    if (pars.register == "true") {
        if (sessionStorage.getItem('administrator') == "1") {
            pars.deviceLimit = -1;
            pars.userLimit = -1;
        } else {
            pars.deviceLimit = 0;
    ...
    if (sessionStorage.getItem('administrator') == "0") {
            ...
            switch (response.status) {
                case 400:
                    ...
                    if(validacion[0] == "Duplicate"){
                        doOpenAlertError("El usuario ya se encuentra registrado");
                    }else{
                        doOpenAlertError($.i18n("message_user_not_permission"));
                    }
                    break;
...
function getRegisterMessage(name, pass, email) {
    ...
    html += '<td style="vertical-align:top" valign="top" align="center"><img src="assets/img/logo.jpg" alt="Bienvenido" title="title text" style="max-height:200px" class="CToWUd"></td></tr></tbody></table>';
    ...
    html += '<table cellspacing="0" cellpadding="0" border="0" align="center"><tbody><tr><td>&nbsp;</td></tr>';
    html += '<tr><td style="vertical-align:top" valign="top"><img src="assets/img/registro.png" alt="Registro exitoso" style="height:88px" class="CToWUd" height="88"></td></tr>';
...
//        html += '<tr><td class="size2">País/região: Brazil</td></tr>
    ...
    html += '<tbody><tr><td style="vertical-align:top;font-family:&quot;MarkFont&quot;,&quot;Helvetica Nue&quot;,&quot;Lucida Grande&quot;,&quot;Lucida Sans Unicode&quot;,Arial,sans-serif;font-size:12px;color:#333333" valign="top" align="center"> <a style="color:#333333" href="http://portal.gpssolution.in/login" rel="noreferrer" target="_blank">Iniciar sesión</a></td></tr></tbody></table>';
...
function doSend_Email_Register() {
    ...
    $.ajax({
        ...
        error: function (response) {
            switch (response.status) {
                default:
                    doOpenAlertError('error when sending email user does not allow');
                    break;
            }
        },
