...
$(document).ready(function () {
   ...
   loadSwitchery();
    ...
    $('button[name="btnSave1"]').click(function () {
        if ($('#form_driver').valid()) { doSaveGroups(); };
    });
...
/**		data:params, */		
        ...
        success: function (response) {
            ...
            $.each(response, function (key, value) {
                ...
                dataSet.push([value.id, ('<img src=assets/img/drivers/' + photo + ' width="50" height="50">'), value.name, description, value.uniqueId, licence,  licencestar, licenceend, html]);
...
function doSaveGroups() {
    ...
    var pars = $("#form_driver").serializeObject();
