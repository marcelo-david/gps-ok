	...
	$.ajax({
        ...
        success: function (response) {
            ...
            $.each(response, function (key, value) {
                ...
                var expirationTime1 = moment(value.expirationTime).format('DD-MM-YYYY'); 
                ...
                if ($("#disabled").val() == 'all' || disabled == $("#disabled").val()) {                    
                    dataSet.push([value.id, deviceIdTemp, document, value.email, expirationTime1, $.i18n("perfil_"+perfil), $.i18n("pais_"+state), value.phone, $.i18n("title_"+disabled)]);                
                 if (names.indexOf($.i18n("perfil_"+perfil)) == -1) {
                                names.push($.i18n("perfil_"+perfil));
                                //marcadores.push();                                                     
                            }       
                }
            });
                           ...
                           extend: 'pdfHtml5',
                            ...
                            doc['header'] = (function (page, pages) {
                                ...
                                doc.content.splice(0, 0,                          
                                  {
                                    alignment: 'left',
                                    text: 'Reporte de accesos de usuarios ',
                                    fontSize: 25
                                  },
                            ...
                            customize: function ( win ) {
                                var header = '<span style="position:absolute;top:53px;left:0;">'+$.i18n('title_disabled')+':'+$.i18n("title_"+$("#disabled").val())+'</span>'+
...
function grafica(nombres, namDevice){
    ...
    var options = {
        ...
        title: {
            text: 'Reporte de perfiles de usuarios'
        },
        subtitle: {
        ...
        yAxis: {
            title: {
                text: 'Conteos totales de perfiles'
            }
