            ...
            $('.datatable-js').dataTable({
                ...
                }, */
                {
                    ...
                    customize: function (win) {
                        var header = '<span style="position:absolute;top:56px;left:0;"><b>'+$.i18n('title_device')+':</b></b></b></b>'+$("#deviceIdFind").select2('data').text +'</span>'+
...
function doSaveGeofenceDevices() {
    ...
    params.maintenanceId = form.maintenanceId;
...
function doDeleteGeofenceDevices(maintenanceId, deviceId) {
...
function getGeofencesGeofenceDevices() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(response, function (key, value) {
                insertOption("maintenanceId", value.id, value.name);
            });
