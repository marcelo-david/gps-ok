                           ...
                           extend: 'pdfHtml5',
                            ...
                            doc['header'] = (function (page, pages) {
                                ...
                                doc.content.splice(0, 0,                          
                                  ...
                                  {
                                    alignment: 'left',
                                    text: $.i18n('title_period') + ':' + $("#from").val() + " Until " + $("#to").val(),
                                    fontSize: 10
                                  },
...
function createMap(dataSet) {
	...
	//var osm	= L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoicmFzdHJlaWVhcXVpIiwiYSI6ImNpemJzOW9ldzBmZHUzM3B4cWtvZ2p3bm8ifQ.s239q_0Nj98HgW14J9bBiA', {
