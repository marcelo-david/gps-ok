        ...
        success: function (response) {
            ...
            $.each(response, function (key, value) {
            	...
            	if (input1Active == true) {
                	...
                	dataSet.push([findDevice(value.deviceId).name, moment(value.deviceTime).format('DD/MM/YYYY HH:mm:ss'), value.address, (value.attributes.input1==true?$.i18n("title_on"):$.i18n("title_off")), convertSpeed(value.speed, 'knots')+ ' '+speedUnit, $.i18n("title_"+device.input1)]);
            	}
            	
            	if (input2Active == true) {
            		var device = findDevice(value.deviceId);            	
                	dataSet.push([findDevice(value.deviceId).name, moment(value.deviceTime).format('DD/MM/YYYY HH:mm:ss'), value.address, (value.attributes.input==true?$.i18n("title_on"):$.i18n("title_off")), convertSpeed(value.speed, 'knots')+ ' '+speedUnit, $.i18n("title_"+device.input2)]);
            	}
            });
