                                        ...
                                        ,{
                                            ...
                                            customize: function ( win ) {
                                                var header = '<span style="position:absolute;top:53px;left:0;">'+$.i18n('title_period')+':'+$("#from").val() + " => " + $("#to").val()+'</span>'+
                                                           // '<img src="' + sessionStorage.getItem('logomark') + '" style="width:100; height:60; position:absolute; top:5; right:10;" />';
...
function grafica(nombres, namDevice){
    ...
    var options = {
        ...
        subtitle: {
            text: 'Full list of events and alarms'
        },
        accessibility: {
            announceNewData: {
                enabled: true
