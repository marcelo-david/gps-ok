	...
	var fenway = new google.maps.LatLng(-8.0522664,-34.9336585,13);
...
$('.datetimepicker').bootstrapMaterialDatePicker({
    ...
    mymap = L.map('mapid', {
        ...
        //Mapa central en CDMX
            mymap.setView([-8.0522664,-34.9336585,13], 13);
	...
	/*	L.Control.Watermark = L.Control.extend({
		...
		$('#btnSupport').on('click', function () {
			$(location).attr('href', "http://api.whatsapp.com/send?1=pt_EN&phone=558140422454");
		});
